#+TITLE: Seminar 5: Passing Off, Image Rights and Geographical Indications
...
* Introduction 
This seminar discusses basic elements of concerning the protection of commercial goodwill under the common law action of "passing off".  It also introduces two slightly more "exotic" IP rights regarding image rights (IR) and geographical indications (GIs).   
